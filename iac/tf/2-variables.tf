...
variable "acm_domain_name" {
  ...
  default     = "acm.trackit.dhdtech.internal"
}
...
variable "cdn_bucket_name" {
  ...
  default     = "tf-dhdtech-cloudfront-bucket"
}
...
variable "ecs_cluster_name" {
  ...
  default     = "ecs-cluster-dhdtech"
}

variable "ecs_service_name" {
  type        = string
  description = "Name of the ECS Service"
  default     = "ecs-service-dhdtech"
}
